...
public class FormTambahAnggota extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Isi Data Anggota");
    ...
    private void buttonSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSimpanActionPerformed
        ...
        if ((nim != null && !nim.isEmpty())
            ...
            boolean sukses = dao.tambahAnggota(anggota);

            //Mengecek berhasil tambah anggota atau tidak
            if (sukses) {
                JOptionPane.showMessageDialog(this, "Data Anggota berhasil ditambahkan");
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Data Anggota gagal ditambahkan");
            }
        } else {
    ...
    private void fieldNimKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fieldNimKeyPressed
        ...
        if ((key >= evt.VK_0 && key <= evt.VK_9)
            ...
            fieldNim.setBackground(Color.white);
        } else {
            fieldNim.setEditable(false);
            fieldNim.setBackground(Color.red);
        }
